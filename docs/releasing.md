...
The current prepared prerelease is `v0.1.0-beta.3`, with release notes in
`.github/releases/v0.1.0-beta.3.md`.
...
```sh
git tag -a v0.1.0-beta.3 -m "fluss-go v0.1.0-beta.3"
git show --no-patch --decorate v0.1.0-beta.3
...
gh release create v0.1.0-beta.3 \
  ...
  --verify-tag \
  --prerelease \
  --title "fluss-go v0.1.0-beta.3" \
  --notes-file .github/releases/v0.1.0-beta.3.md
```
...
```sh
test "$(git rev-parse v0.1.0-beta.3^{})" = "$(git rev-parse origin/main)"
gh release view v0.1.0-beta.3 --repo pletorco/fluss-go
```
...
GOPROXY=https://proxy.golang.org GONOSUMDB= \
  go list -m -json github.com/pletorco/fluss-go@v0.1.0-beta.3
```

Confirm that the returned `Version` is `v0.1.0-beta.3` and that its origin hash
...
- `https://pkg.go.dev/github.com/pletorco/fluss-go/pkg/fmsg@v0.1.0-beta.3`
- `https://pkg.go.dev/github.com/pletorco/fluss-go/pkg/fgo@v0.1.0-beta.3`
- `https://pkg.go.dev/github.com/pletorco/fluss-go/pkg/fadm@v0.1.0-beta.3`
