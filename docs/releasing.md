...
The current prepared prerelease is `v0.1.0-beta.4`, with release notes in
`.github/releases/v0.1.0-beta.4.md`.
...
```sh
git tag -a v0.1.0-beta.4 -m "fluss-go v0.1.0-beta.4"
git show --no-patch --decorate v0.1.0-beta.4
...
gh release create v0.1.0-beta.4 \
  ...
  --verify-tag \
  --prerelease \
  --title "fluss-go v0.1.0-beta.4" \
  --notes-file .github/releases/v0.1.0-beta.4.md
```
...
```sh
test "$(git rev-parse v0.1.0-beta.4^{})" = "$(git rev-parse origin/main)"
gh release view v0.1.0-beta.4 --repo pletorco/fluss-go
```
...
GOPROXY=https://proxy.golang.org GONOSUMDB= \
  go list -m -json github.com/pletorco/fluss-go@v0.1.0-beta.4
```

Confirm that the returned `Version` is `v0.1.0-beta.4` and that its origin hash
...
- `https://pkg.go.dev/github.com/pletorco/fluss-go/pkg/fmsg@v0.1.0-beta.4`
- `https://pkg.go.dev/github.com/pletorco/fluss-go/pkg/fgo@v0.1.0-beta.4`
- `https://pkg.go.dev/github.com/pletorco/fluss-go/pkg/fadm@v0.1.0-beta.4`
